...
occasion.  And the rest of the Regal team for friendship and support.
...
%The textheight is \showthe\textheight.
%The textWidth is \showthe\textwidth.
\input{intro}
\input{background}
\input{methods}
\input{results}
...
\addcontentsline{toc}{schapter}{\bibname}   %do NOT substitute your bibname
