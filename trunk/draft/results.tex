...
different SOMS.  On the fastest of those machines the training one SOM took
around forty-five (45) minutes.  In contrast SOM\_PAK takes only ninety (90)
seconds to train the hexagon SOM with the same training parameters.  This
...
forty SOMs into four groups.  Resulting in one sample for each of the four
