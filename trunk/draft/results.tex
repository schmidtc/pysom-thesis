...
In figure \ref{cplanes} the component planes of these simulations are
presented.  The variation we see in the placement of high and low values,
between topologies, is caused by the random initialization of the SOM.
However, the relationships between the dimensions remain constant across
topologies. 

Focusing on in the internal variance of 
