...
\subfigure[Rectangular Topology]{
  \label{ten:rook}
  \includegraphics[width=0.45\linewidth]{rook_thesis_7c.png}
}
\subfigure[Hexagonal Topology]{
  \label{ten:hex}
  \includegraphics[width=0.45\linewidth]{hex_thesis_7c.png}
}
\subfigure[Spherical Topology]{
  \label{ten:graph}
  \includegraphics[width=0.45\linewidth]{sphere_thesis_7c.png}
}
\subfigure[Geodesic Sphere Topology]{
  \label{ten:geodesic}
  \includegraphics[width=0.45\linewidth]{geodesic_thesis_7c.png}
}
\caption{Internal variance mapping for each of the forty SOMs.}
\label{ten}
\end{minipage}
\end{figure}


%  \includegraphics[width=\linewidth]{sphere_thesis_7c.png}
%}
%\subfigure[Geodesic Sphere Topology]{
%  \label{ten:geodesic}
%}
%\caption{Visualization of the internal variance for each of the forty SOMs.}
%\label{ten}
%\end{figure}
