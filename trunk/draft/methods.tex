...
SOMs neurons closer to the edge, those with fewer neighbors, will have higher internal variances. This can
be extended to spherical SOMs by comparing the degree of a neuron ($deg(m_i)$
or the number of adjacent neurons) to its internal variance.  If the
relationship is directly related to the number of neighbors, neurons with lower
degrees in spherical SOMs should display higher internal variances.  The degree of
