...
literature has largely ignored the more irregular methods in favor of
...
\begin{enumerate}
	\item Visualize the reverse quantization error by mapping neurons back onto the input data.
...
to address the research question regarding the internal variance and
neighborhood size.  The third diagnostic will address the question concerning
internal variance and topological irregularity.
...
\begin{itemize}
\item In order to test the methods described above, I will generate
high-dimensional synthetic data with known properties.
