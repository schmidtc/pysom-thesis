...
%In traditional SOM do neurons closer to the edge of the grid have higher internal variances?
Does the internal variance of each neuron increase as its first-order
neighborhood size, or degree, decreases?

\subsection{Hypothesis \#1}
%It is expected that in traditional SOM neurons closer to the edge will have higher internal variances.
