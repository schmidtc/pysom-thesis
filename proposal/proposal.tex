...
\end{center}
The development of the spherical Self-Organizing Map (SOM) has been driven by the border effects
...
Both of these stem from the problem of uniformly distributing points on
a sphere. 

\noindent
\\
These problems will be investigated through the introduction of a new
...
an overwhelming about of synthetic data.  I can then compare each neuron's
internal variance, defined by the variance of the observations that best fit
that neuron, as an attempt to discover the effects of topological
irregularity.    
