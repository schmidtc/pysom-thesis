...
proposes that the relationship between SOM and GIScience should be
bidirectional.  As explained below, the SOM is a type of artificial neural
...
Neurons on the boundary of the lattice have fewer neighbors, this becomes
important during the self-organizing process.  Using a spherical lattice is
