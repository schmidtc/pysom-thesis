...
developed by Teuvo Kohonen as a technique to analyze and visualize high dimensional data sets.
As explained below, the SOM is a type of artificial neural network, which
traditionally uses a rectangular or hexagonal grid or lattice of neurons.  The
SOM algorithm facilitates a self organizing process by allowing a set of training
data to arrange themselves on neural network.  When
using one of these traditional lattices neurons near the edge of the network have
...
problem and the choice of which spherical topology to use for the network is
difficult make.
