...
defined by the census variables used by \site{skupin08}.  However, as shown in
...
\caption{An example of how spherical SOM address the boundary effect found in
traditional SOM.}
\label{sphere:states}
\end{figure}
...
Utah and Hawaii are separated in this SOM.  Suggesting that edge effects indeed
played a large role in the placement of this two observations in the hexagonal
SOM.  As suggested in section \ref{bg:sphere}, we also find these and other
outlying observations also more space in the trained spherical SOM.  States
closer to the mean such as Ohio, Missouri and Kentucky are distinctly more
clustered in the spherical SOM than they are in the hexagonal SOM.  It is
interesting to note that the orientation between these three states remained
largely unchanged.
